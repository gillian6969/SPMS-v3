          ...
          <div class="modal-body">
            ...
            <div v-if="!isEditing">
              <div class="info-grid">
                ...
                <div class="info-item">
                  <label>Counseling Year</label>
                  <span>{{ editForm.counselingYear }}</span>
                </div>
            ...
            <form v-else @submit.prevent="updateTeacher">
              <div class="info-grid">
                ...
                <div class="info-item">
                  <label>Counseling Year</label>
                  <select v-model="editForm.counselingYear" required>
                    <option value="1st">1st Year</option>
                    <option value="2nd">2nd Year</option>
                    <option value="3rd">3rd Year</option>
                    <option value="4th">4th Year</option>
  ...
  export default {
    ...
    setup() {
      ...
      const availableSubjects = computed(() => {
        return editForm.value.counselingYear ? subjectsByYear[editForm.value.counselingYear] : []
      })
      ...
      const filteredTeachers = computed(() => {
        return teachers.value.filter(teacher => {
          ...
          const matchesYear = yearFilter.value === '' || teacher.counselingYear === yearFilter.value
      ...
      const toggleEdit = () => {
        if (isEditing.value) {
          editForm.value = {
            ...
            counselingYear: selectedTeacher.value.counselingYear,
